...
public class AdminAccuseController {
    ...
    @PatchMapping("/admin/accuse/delete/{accuseId}")
    public ResponseEntity<ResponseResult<Long>> deleteAccuse(@PathVariable Long accuseId) throws IllegalAccessException {

        return ResponseEntity.status(HttpStatus.OK).body(adminAccuseService.deleteAccuse(accuseId));
    }
}
